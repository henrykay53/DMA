        ...
        <div>
            ...
            <div className='w-[90%] mx-auto lg:mx-4' >
                ...
                <div className='flex justify-between items-center mt-6 mb-5 '>
                    <p className='font-bold text-xl text-accent '>Customers - Unassigned Customers</p>

                    <div className='hidden lg:flex gap-10'>
                        <button onClick = {()=>setAddNew(!addNew)} className='flex items-center gap-2 font-bold text-black rounded-full px-4 py-2 ring-2 ring-accent hover:text-white hover:bg-accent'>Add New</button>
...
export default UnassingnedCustomers;

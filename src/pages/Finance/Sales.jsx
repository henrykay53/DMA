      ...
      <div className='flex items-align bg-blue-gray-50'>
        ...
        <div className='w-[90%] mx-auto lg:mx-4'>
          ...
          <div className='flex justify-between items-center mt-6 mb-5 '>
            <p className='font-bold text-xl text-accent '>Finance - Sales</p>

            <div className='hidden lg:flex gap-10'>
              <button className='flex items-center gap-2 font-bold  rounded-full px-4 py-2 ring-2 ring-accent hover:text-white hover:bg-accent'>Add New</button>
              <button className='flex items-center gap-2 font-bold   rounded-full px-4 py-2 ring-2 ring-accent hover:text-white hover:bg-accent'>Send Email</button>
              <button className='flex items-center gap-2 font-bold   rounded-full px-4 py-2 ring-2 ring-accent hover:text-white hover:bg-accent'>Notes</button>
              <button className='flex items-center gap-2 font-bold   rounded-full px-4 py-2 ring-2 ring-accent hover:text-white hover:bg-accent'>Schedule Meeting</button>
              <button className='flex items-center gap-2 font-bold   rounded-full px-4 py-2 ring-2 ring-accent hover:text-white hover:bg-accent'>Task Reminder</button>
              <button className='flex items-center gap-2 font-bold   rounded-full px-4 py-2 ring-2 ring-accent hover:text-white hover:bg-accent'>Log Activities</button>

...
function CertificatesLicense() {
  ...
  const closeUpdate = () => { setUpdateDocument(false); };
  ...
  useEffect(() => {
    const filteredDocuments = documents.filter(
      (document) => document.archiveType === "Certificate_Lincense"
    );
      ...
      cell: ({ row }) => {
        return (
          <div className="flex gap-2 ">
            ...
            <Button onClick={()=> handleEdit(row.original.id)} className="bg-yellow-500 hover:bg-yellow-300 p-2 rounded-lg">
              Edit
            </Button>
            <Button
      ...
      <div className="flex">
        ...
        <div className="w-[98%] mx-4">
          ...
          <div className="font-bold text-4xl lg:text-4xl text-accent py-6 flex gap-4 justify-center items-center">
            <p className="mt-8">Certificate License</p>
          ...
          <div className="flex justify-center">
            {updateDoc ? (
              <UpdateDocument close={updateDoc} closeUpdate={closeUpdate} rowId={identity}/>
            ) : (
              ""
            )}
          </div>

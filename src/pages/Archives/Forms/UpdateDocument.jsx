...
const UpdateDocument = ({ close, closeUpdate, rowId }) => {
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${API_BASE_URL}/Archive`, formData, {
        headers: {
  ...
  return (
    <div className="absolute top-0 mt-10 z-10 w-[30%] bg-white shadow-2xl p-6">
      <ToastContainer autoClose={2000} />

      <div className="flex justify-between items-center">
        <div className="text-4xl text-center text-accent font-bold ml-4">
          EDIT
        </div>
        <div
          className="p-2 rounded-sm bg-red-200"
          onClick={() => closeUpdate(!close)}
        >

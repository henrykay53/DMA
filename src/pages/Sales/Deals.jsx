    ...
    <div>
      ...
      <div className='w-[90%] mx-auto lg:mx-4'>
        ...
        <div className='flex justify-between items-center mt-6 mb-5 '>
          <p className='font-bold text-xl text-accent '>Sales - Deals</p>

          <div className='flex gap-10'>
            <input className=' ring-2 ring-accent focus:outline-accent p-2 rounded-lg font-bold text-accent' placeholder='Search' type="text" value={filter} onChange={(e) => setFilter(e.target.value)} />
          </div>

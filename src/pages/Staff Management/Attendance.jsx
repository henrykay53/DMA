      ...
      <div className='flex items-align'>
        ...
        <div className='w-[90%] mx-auto lg:mx-4'>
          ...
          <div className='flex justify-between items-center mt-6 mb-5 '>
            <p className='font-bold text-xl text-accent '>Staff management - Attendance</p>

            <div className='lg:flex gap-10 hidden'>
              <button className='flex items-center gap-2 font-bold text-black rounded-full px-4 py-2 ring-2 ring-accent  hover:text-white hover:bg-accent'>Add New</button>

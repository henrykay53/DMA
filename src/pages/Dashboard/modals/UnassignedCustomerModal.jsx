...
const UnassignedCustomersModal = ({ figure, label, percentage }) => {
    return (
        <div className='rounded-lg bg-white p-10 mt-10 mb-10 text-center'>
...
export default UnassignedCustomersModal
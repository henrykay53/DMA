        ...
        <div>
            ...
            <div className="">
                ...
                <div className='flex gap-4 mt-10 '>
                    ...
                    <button disabled={!table.getCanPreviousPage()} onClick={() => table.previousPage()} className='text-accent font-bold ring-2 ring-accent hover:bg-accent hover:text-white py-2 px-4 rounded-full shadow-lg'>Prev Page</button>
                    <button disabled={!table.getCanNextPage()} onClick={() => table.nextPage()} className='text-accent font-bold ring-2 ring-accent focus:ring-[] hover:bg-accent hover:text-white py-2 px-4 rounded-full shadow-lg'>Next Page</button>
